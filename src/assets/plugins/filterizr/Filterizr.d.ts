...
export default class Filterizr {
    ...
    static defaultOptions: typeof RawOptions;
    /**
    ...
    constructor(selectorOrNode?: string | HTMLElement, userOptions?: typeof RawOptions);
     ...
     */
    setOptions(newOptions: typeof RawOptions): void;
    /**
